...
export default function AIMarketingEngagementPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main>
                {/* Hero Section */}
                <section className="section-padding bg-gradient-to-br from-orange-50 to-indigo-50">
                ...
                {/* Stats Section */}
                <section className="section-padding bg-gradient-to-r from-indigo-50 to-orange-50">
                    <div className="container-custom">

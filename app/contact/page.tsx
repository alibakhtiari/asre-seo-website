...
const metadata = {
  title: 'تماس با ما | شماره تلفن | آدرس دفتر | عصر سئو',
  description: 'تماس با تیم متخصص عصر سئو. مشاوره رایگان دیجیتال مارکتینگ، شماره تلفن 021-12345678، آدرس، ساعات کاری و فرم تماس آنلاین.',
  keywords: 'تماس با عصر سئو, شماره تلفن, آدرس, مشاوره رایگان, فرم تماس',
  alternates: {
    canonical: 'https://asreseo.com/contact',
  },
  openGraph: {
    title: 'تماس با ما | عصر سئو',
    description: 'تماس با تیم متخصص عصر سئو برای مشاوره رایگان.',
    type: 'website',

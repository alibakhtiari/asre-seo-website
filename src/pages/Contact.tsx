              ...
              <div className="lg:col-span-2">
                <Card className="shadow-lg hover:shadow-xl transition-shadow animate-fade-in">
                  <CardContent className="p-8">
                    <h2 className="text-2xl font-bold text-foreground mb-6">فرم تماس</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                          <label className="block text-sm font-medium text-foreground mb-2">سرویس مورد نظر</label>
                          <select
                            name="service"
              ...
              <div className="space-y-8">
                ...
                <Card className="shadow-lg hover:shadow-xl transition-shadow animate-fade-in">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-foreground mb-6">اطلاعات تماس</h3>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3 space-x-reverse">
                        ...
                        <div>
                          <div className="font-medium text-foreground">تلفن تماس</div>
                          <div className="text-muted-foreground">021-12345678</div>
                          <div className="text-muted-foreground">0912-345-6789</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 space-x-reverse">
                        ...
                        <div>
                          <div className="font-medium text-foreground">ایمیل</div>
                          <div className="text-muted-foreground">info@asreseo.com</div>
                          <div className="text-muted-foreground">support@asreseo.com</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 space-x-reverse">
                        ...
                        <div>
                          <div className="font-medium text-foreground">آدرس</div>
                          <div className="text-muted-foreground">تهران، خیابان ولیعصر، پلاک ۱۲۳</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 space-x-reverse">
                        ...
                        <div>
                          <div className="font-medium text-foreground">ساعات کاری</div>
                          <div className="text-muted-foreground">شنبه تا پنج‌شنبه: ۹ تا ۱۸</div>
                          <div className="text-muted-foreground">پشتیبانی آنلاین: ۲۴/۷</div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="shadow-lg hover:shadow-xl transition-shadow animate-fade-in">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-foreground mb-4">دسترسی سریع</h3>
                ...
                {/* Emergency Contact */}
                <Card className="shadow-lg hover:shadow-xl transition-shadow animate-fade-in bg-gradient-to-br from-primary/5 to-secondary/5">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-foreground mb-2">تماس اضطراری</h3>
                    <p className="text-muted-foreground text-sm mb-4">برای موارد فوری و خارج از ساعت کاری</p>

...
const NotFound = () => {
  ...
  useEffect(() => {
    ...
    // Log to analytics if available - simplified to avoid TypeScript issues
    if (typeof window !== 'undefined') {
      console.log('404 Error logged:', router.asPath);
    }
  }, [router.asPath]);
      ...
      <div className="text-center relative z-10 max-w-2xl mx-auto px-4">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              size="lg"
              className="gradient-bg text-white px-8 py-3 text-lg hover:opacity-90 transition-all duration-200 transform hover:scale-105"
              onClick={() => router.push('/')}
            >
